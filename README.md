...
- Set rules at **version**, with **Up to Next Major** option and put **2.3.3** as its version
- Click next and wait
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/Pharos.git", .upToNextMajor(from: "2.3.3"))
]
```
